    ...
    public static string GiveAName(int type)
    {
        ...
        if (type > 0)
        {
            if (type <= 4)  //  Normal English Names ---------------------------
            {
                ...
                {
                    firstName = new string[] { "101Ways", "3D Waffle", "44", "57 Pixels", "Accidental Genius", "Acid Gosling", "Admiral Tot", "AgentHercules",
                        "Airport Hobo", "Alley Frog", "Alpha", "AlphaReturns", "Angel", "AngelsCreed", "Arsenic Coo", "Atomic Blastoid", "Automatic Slicer",
                        "Baby Brown", "Back Bett", "Bad Bunny", "Bazooka Har-de-har", "Bearded Angler", "Beetle King", "Betty Cricket", "Bit Sentinel", "Bitmap",
                        "BlacKitten", "Blister", "Blistered Outlaw", "Blitz", "BloodEater", "Bonzai", "BoomBeachLuvr", "BoomBlaster", "Bootleg Taximan", "Bowie",
                        "Bowler", "Breadmaker", "Broomspun", "Buckshot", "Bug Blitz", "Bug Fire", "Bugger", "Cabbie", "Candy Butcher", "Capital F",
                        "Captain Peroxide", "Celtic Charger", "Centurion Sherman", "Cereal Killer", "Chasm Face", "Chew Chew", "Chicago Blackout", "Chip Queen",
                        "ChocoNutsX", "Chocolate Thunder", "Chuckles", "Club Nola", "CoB@lt", "CobraBite", "Cocktail", "CollaterolDamage", "CommandX", "Commando",
                        "Congo Wire", "Cool Iris", "Cool Whip", "Cosmo", "Crash Override", "Crash Test", "Crazy Eights", "Criss Cross", "Cross Thread", "Cujo",
                        "Cupid Dust", "Daffy Girl", "Dahlia Bumble", "DaisyCraft", "Dancing Madman", "Dangle", "DanimalDaze", "Dark Horse", "Darkside Orbit",
                        "Darling Peacock", "Day Hawk", "Desert Haze", "Desperado", "Devil Blade", "Devil Chick", "Dexter", "Diamond Gamer", "Digger", "Disco Potato",
                        "Disco Thunder", "DiscoMate", "Don Stab", "Doz Killer", "Dredd", "DriftDetector", "DriftManiac", "Drop Stone", "Dropkick", "Drugstore Cowboy",
                        "DuckDuck", "Earl of Arms", "Easy Sweep", "Eerie Mizzen", "ElactixNova", "Elder Pogue", "Electric Player", "Electric Saturn", "Ember Rope",
                        "Esquire", "ExoticAlpha", "EyeShooter", "Fabulous", "Fast Draw", "FastLane", "Father Abbot", "FenderBoyXXX", "Fennel Dove", "Feral Mayhem",
                        "Fiend Oblivion", "FifthHarmony", "Fire Feline", "Fire Fish", "FireByMisFire", "Fist Wizard", "Flakes", "Flame OUT", "Flint", "FlyGuardX",
                        "Flying Doodle", "FrankenGrin", "Freak", "Frozen Explosion", "Gadget", "Gas Man", "General Broomdog", "General Finish", "Ghostrider",
                        "Global meltdown", "Glyph", "Goatee Shield", "Gov Skull", "Grave Digger", "Greek Rifle", "Green Ghost", "Green Scavenger", "Guillotine",
                        "Gullyway", "Guncap Slingbad", "Gunhawk", "HeroOfBlackday", "High Kingdom Warrior", "Highlander Monk", "Hightower", "Hog Butcher", "HollySparta",
                        ...
                        "Landfill Max", "Lava Nibbler", "Lazy Killer", "LeSpank", "LexusGTXXX", "LifeRobber", "Light Lion", "LightInOut", "Liquid Death",
                        "Liquid Science", "Little Cobra", "Little General", "LittleTickle", "Lope Lope", "Lord Nikon", "Lord Pistachio", "Lord Theus",
                        "Lucifer%u2019s rain", "Lucky", "LunaStar", "Lunar Treat", "Mad Irishman", "Mad Jack", "Mad Kid", "Mad Rascal", "Mad Robin",
                        "ManMaker", "Manimal", "Marbles", "Marigold Loot", "Married Man", "MarshalKing", "Marshmallow", "MaxicanChoncho", "MeetWit",
                        "Mental", "Mercury Reborn", "Metal Star", "Midas", "Midnight Rambler", "Midnight Rider", "MightyFellow", "MindBuggle",
                        "Mindless Bobcat", "Mint Ness", "MonkeyKing", "MonkeySmash", "MonsterMania", "Moon Solitaire", "Mud Pie Man", "Mule Skinner",
                        "Mum Mary", "Murmur", "Mustang", "MysteryEnds", "Mystic", "Nacho", "Natural Gold", "Natural Mess", "Necromancer", "NemesisX",
                        "Neophyte Believer", "Nessie", "New Cycle", "New York Winder", "Nickname Master", "Night Magnet", "Night Train", "Nightmare King",
                        "NoiseFire", "Nutmeg Riot", "Old Man Winter", "Old Orange Eyes", "Old Regret", "Omega Sub", "Onion King", "Osprey", "Overrun",
                        "Papa Smurf", "Paradise", "Pearl Girl", "Pepper Legs", "Peppermint", "Phoenix Tetra", "PhoenixHeat", "Pinball Wizard", "Pink Hopper",
                        "PinkFloyd", "PinkPanther", "Pistol Hydro", "Pixie Soldier", "Pluto", "Pogue", "Polar Bee", "Poppy Coffee", "Poptart AK47", "Prometheus",
                        "Psycho Thinker", "Pusher", "Racy Lion", "RadioactiveMan", "Raid Bucker", "Rando Tank", "Ranger", "Red Combat", "Red Rhino", "RedFeet",
                        "RedFisher", "RedMouth", "Reed Lady", "Renegade Slugger", "Reno Monarch", "Returns", "RevengeOfOmega", "Riff Raff", "Roadblock",
                        "RoarSweetie", "Rocky Highway", "Roller Turtle", "Romance Guppy", "Rooster", "Rude Sniper", "Saint La-Z-Boy", "Sandbox",
                        "Scare Stone", "ScaryNinja", "ScaryPumpkin", "Scrapper", "Scrapple", "Screw", "Screwtape", "Seal Snake", "Sexual Chocolate",
                        "Shadow Bishop", "Shadow Chaser", "Sherwood Gladiator", "Shooter", "ShowMeSunset", "ShowMeUrguts", "Sidewalk Enforcer",
                        "Sienna Princess", "Silver Stone", "Sir Shove", "Skull Crusher", "Sky Bully", "Sky Herald", "Slow Trot", "SmartieQuest",
                        "SmashBuster", "SmashDtrash", "Snake Eyes", "SnakeEye", "SniperInstinct", "SnoopWoot", "Snow Cream", "Snow Hound",
                        "Snow Pharaoh", "SnowWhiteLuvr", "Sofa King", "Solo Kill", "SpeedBreaker", "Speedwell", "SpellTansy", "Spider Fuji",
                        "Spike", "SpitFire", "Spooky Yellowjacket", "Springheel Jack", "Spunky Comet", "Spy", "Squatch", "Stacker of Wheat", "Stallion Patton",
                        "Star Sword", "Station WMD", "Street Squirrel", "Subzero Taffy", "Sugar Man", "Suicide Jockey", "Sultan of Speed", "SunVolt",
                        "Swampmasher", "Sweet Talker", "Swerve", "SwiftFox", "SwiftSpeed", "TWitMeet", "Tacklebox", "Take Away", "Tan Stallion", "TecTonic",
                        "Terror Master", "Thanksgiving", "The China Wall", "The Dude", "The Final Judgement", "The Flying Mouse", "The Happy Jock", "The Howling Swede",
                        "The Shield Toronto", "Third Moon", "Thrasher", "ThunderStroke", "Toe", "Toolmaker", "Tough Nut", "ToxicCharger", "Toy Dogwatch", "Trash Master",
                        "Trash Sling", "Trick Baron", "Trip", "TrixiePhany", "Troubadour", "TulipCake", "Turnip King", "Twin Blaze", "Twinkle Cutlass", "Twitch",
                        "Twix Bond", "UCantBeatIt", "Uncle Psycho", "Vagabond Warrior", "VenusLion", "VenusQueen", "Vicious Street", "Voluntary", "Vortex",
                        "Washer", "Waylay Dave", "Wheels", "White Snare", "Wholesome", "Widow Curio", "Willow Dragon", "WindyGod", "Winter Bite", "Wolf Tribune",
                ...
                else if (type == 3)  //  Male Old Name (280)
                {
                    firstName = new string[] { "Aaron", "Adam", "Alan", "Albert", "Alexander", "Alfred", "Allan", "Allen", "Alvin", "Andre", "Andrew", "Anthony",
                        ...
                        "Bruce", "Bryan", "SS", "23", "Carlos", "Chad", "Charles", "Charlie", "Chris", "Christopher", "Clarence", "Clifford", "Clyde", "Craig",
                        "Curtis", "123", "Dan", "Dana", "Daniel", "Danny", "Darin", "Darrell", "Darren", "Darryl", "Daryl", "Dave", "David", "Dean", "Dennis", "Derek",
                        "Derrick", "Don", "102", "Donnie", "Douglas", "Duane", "Dwayne", "Dwight", "Earl", "Eddie", "Edward", "Edwin", "Eric", "Erik", "Ernest",
                        ...
                        "Lewis", "Lloyd", "Lonnie", "XXX", "Big", "Lynn", "Manuel", "Marc", "Marcus", "Mark", "Martin", "Marvin", "Matthew", "Maurice", "Melvin",
